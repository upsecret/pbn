...
export const metadata: Metadata = {
  title: "Highlands Ranch | KidsTown Drop-In Child Care",
  description: "KidsTown Drop-In Child Care in Highlands Ranch, Colorado. Walk-in care for children ages 1-13.",
};
  ...
  return (
    <main>
      ...
      <section className="relative h-72 md:h-80 flex items-end overflow-hidden">
        <Image
          src="/images/highlands-ranch.jpg"
          alt="Highlands Ranch KidsTown location"
          fill
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-6 pb-10">
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-2">Highlands Ranch</h1>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-700 text-sm">
              <div className="flex gap-3 items-start">
                ...
                <span>123 Main Street, Highlands Ranch, CO 80130</span>
              </div>
