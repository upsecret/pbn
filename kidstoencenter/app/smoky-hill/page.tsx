...
export const metadata: Metadata = {
  title: "Smoky Hill | KidsTown Drop-In Child Care",
  description: "KidsTown Drop-In Child Care in Smoky Hill, Colorado. Walk-in care for children ages 1-13.",
};

export default function SmokyHillPage() {
  return (
    <main>
      {/* Hero */}
      <section className="relative h-72 md:h-80 flex items-end overflow-hidden">
        <Image
          src="/images/smoky-hill.jpg"
          alt="Smoky Hill KidsTown location"
          fill
        ...
        <div className="relative z-10 w-full max-w-4xl mx-auto px-6 pb-10">
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-2">Smoky Hill</h1>
          ...
          <div>
            ...
            <div className="space-y-3 text-gray-700 text-sm">
              <div className="flex gap-3 items-start">
                ...
                <span>789 Smoky Hill Road, Aurora, CO 80015</span>
              </div>
